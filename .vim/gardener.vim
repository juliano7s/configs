...
" Colors for the User Interface.
    ...
    if exists("g:gardener_soil")
        hi Normal           guibg=#332211     guifg=black gui=none 
    else
    ...
    hi IncSearch        guibg=#0066cc     guifg=black 	   gui=none
...
" Colors for the User Interface.
    ...
    exec "hi IncSearch      cterm=NONE   ctermfg=232   ctermbg=178"
    exec "hi Search         cterm=NONE   ctermfg=232   ctermbg=155"
    ...
    exec "hi StatusLineNC   cterm=NONE   ctermfg=250   ctermbg=234"
    exec "hi StatusLine     cterm=BOLD   ctermfg=250   ctermbg=237"
    exec "hi VertSplit      cterm=NONE   ctermfg=250   ctermbg=237"
