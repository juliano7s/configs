...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\033k\033\\$ '
else
...
function color_prompt
{
 ...
 local BRIGHTYELLOW="\[\033[1;33m\]"

 #PS1="${WHITE}.oO(${GREEN}\u${BRIGHTGREEN}@${GREEN}\h ${CYAN}\w${WHITE})${GRAY} "
 #PS1="${CYAN}[\u@\h ${RED}\w${CYAN}]${GRAY} "
#export PS1="${BLUE}\w${WHITE}\n[${BRIGHTBLUE}\u${WHITE} ${BRIGHTGREEN}\W${WHITE}]\$ "
 export PS1="${WHITE}[${BRIGHTBLUE}\u${WHITE} ${BRIGHTGREEN}\W${WHITE}]\$ "
